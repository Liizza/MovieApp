...
class SearchViewController: BaseViewController {
    ...
    private func setUpSearchResultTableView() {
        ...
        viewModel.movies.drive(searchResultsTable.rx.items(cellIdentifier: "MovieTableViewCell", cellType: MovieTableViewCell.self)){ row, item, cell in
    ...
    private func setUpSearchHistoryTableView() {
        ...
        viewModel.searchRequests.drive(searchHistoryTableView.rx.items(cellIdentifier: "SearchHistoryTableViewCell", cellType: SearchHistoryTableViewCell.self)){ row, item, cell in
