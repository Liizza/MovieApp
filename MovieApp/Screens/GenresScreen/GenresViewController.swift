...
class GenresViewController: BaseViewController {
    ...
    var viewModel:GenresViewViewModel?
    ...
    private func setUpTableView() {
        ...
        viewModel.genres.drive(genresTableView.rx.items(cellIdentifier: "GenreTableViewCell", cellType: GenreTableViewCell.self)){  row, item, cell in
